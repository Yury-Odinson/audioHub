...
import { buttonBack, buttonNext, buttonPlay, songName, audio, progressStart, progressEnd, progressBar, progress } from "./declaration.js";

const songs = ["embrace", "2015-1 - Fraytime", "2016-4 - Empty Hollow", "2018-3 - Darkness", "2020-1 - Nostalgia", "vodokanal-minus"];
